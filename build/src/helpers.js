...
const log = (0, freelancer_shared_1.winstonLogger)(`${config_1.config.ELASTIC_SEARCH_URL}`, 'mailTransportHelper', 'debug');
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const email = new email_templates_1.default({
                message: {
                    from: `Freelancer App <${config_1.config.SENDER_EMAIL}>`
                },
                send: true,
                preview: false,
